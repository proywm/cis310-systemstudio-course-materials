...
\begin{itemize}
  ...
  \item User, deployment, privacy, and maintenance documentation; automated test suite; final demonstration and evaluation report.
\end{itemize}
\end{minipage}\hfill
\begin{minipage}[t]{0.49\linewidth}
...
\begin{itemize}
  ...
  \item Faculty review and student usability testing document correctness, setup success, time to useful feedback, and remaining limitations.
\end{itemize}
\end{minipage}
