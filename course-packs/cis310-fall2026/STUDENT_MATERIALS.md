...
Open **Start Here → Prepare Lecture 1** for the next self-paced pre-class module. Each module follows **Read → Watch → Try 3 questions**. Begin with sources tagged **Readiness source**; the other listed items are additional references. The readings are focused sections of David Tarnoff's free *Computer Organization and Design Fundamentals*; the videos come from Tarnoff's official channel or ETSU OER series. Under **Learn and Practice**, you can also select one of six topics, take a 10-question quiz, or review questions that are due or saved. Practice mode gives feedback after each question; quiz mode gives feedback at the end. Choose a confidence level before submitting, then use the explanation, visibly labeled mapped reading/video focus, and packaged lecture. A module is checked only after three distinct questions have been tried.
...
|---|---|---|---|
| Lecture 1: Introduction and data representation | [Ch. 1](https://faculty.etsu.edu/tarnoff/ntes2150/Ch1_v02.pdf), §§1.2–1.7; [Ch. 2](https://faculty.etsu.edu/tarnoff/ntes2150/Ch2_v02.pdf), §2.7; [Ch. 15](https://faculty.etsu.edu/tarnoff/ntes2150/Ch15_v02.pdf), §§15.1–15.4 | [Ep 001: Digital Signal](https://www.youtube.com/watch?v=2jfoLxQXq3Y); [Ep 006: Hexadecimal](https://www.youtube.com/watch?v=HoZ8_UIziX8); [Ep 079: CPU Architecture](https://www.youtube.com/watch?v=YNAcQ-uVM7Y) | Try the 3-question Lecture 1 check |
| Lecture 2: Signed data, Boolean logic, and adders | [Ch. 2](https://faculty.etsu.edu/tarnoff/ntes2150/Ch2_v02.pdf), §§2.3–2.5; [Ch. 3](https://faculty.etsu.edu/tarnoff/ntes2150/Ch3_v02.pdf), §§3.1–3.3; [Ch. 8](https://faculty.etsu.edu/tarnoff/ntes2150/Ch8_v02.pdf), §8.1 | [Ep 004: Binary to Decimal](https://www.youtube.com/watch?v=hBdGOb8w4DA); [Ep 014: Two's Complement](https://www.youtube.com/watch?v=Ix8mP_xneFc); [Ep 012: Binary Addition](https://www.youtube.com/watch?v=YyxlNN8l0zw) | Try the Lecture 2 check |
...
| Lecture 8: I/O and interrupts | [Ch. 15](https://faculty.etsu.edu/tarnoff/ntes2150/Ch15_v02.pdf), §§15.9.1–15.9.2 | [Ep 086: Introduction to I/O](https://www.youtube.com/watch?v=nnO2OfSTVbA); [Ep 087: Polled I/O](https://www.youtube.com/watch?v=xNH1e5snIEY) | Try the Lecture 8 check |
...
| Lecture 12: x86 and assembly | [Ch. 15](https://faculty.etsu.edu/tarnoff/ntes2150/Ch15_v02.pdf), §15.2.5; [Ch. 16](https://faculty.etsu.edu/tarnoff/ntes2150/Ch16_v02.pdf), §§16.2.1–16.2.3; [Ch. 17](https://faculty.etsu.edu/tarnoff/ntes2150/Ch17_v02.pdf), §§17.4.1–17.4.3 | [Ep 080: Registers/EIP](https://www.youtube.com/watch?v=th8FnKQNIYE); [Ep 081: Stack Pointer](https://www.youtube.com/watch?v=n8_2y5E8N4Y); [Ep 082: Functions/Stack](https://www.youtube.com/watch?v=mC5eNUpyfKY); [Ep 083: Flags](https://www.youtube.com/watch?v=7eaTT8PekE0) | Try the Lecture 12 check |
...
Use **CIS 310: Create Assembly Toolchain and Trace Examples**. Open `assembly/real-toolchains/nasm-linux/LoopSum.asm` and choose **Build and Run with Real Assembly Toolchain** for actual NASM, GNU linking, and IA-32 execution. On a configured Windows host, `assembly/real-toolchains/masm-irvine/AddTwo.asm` uses Microsoft `ml.exe`, Microsoft `link.exe`, and the official Irvine32 library.

For prediction practice, open a formative source under `assembly/irvine32/` or `assembly/nasm-ia32/` with **Instruction Trace Tutor**. Its teaching model can show registers, flags, data, stack, virtual input/output, EIP, and recent trace, but it is not an assembler and does not generate binaries. Read `assembly/IRVINE32_PROFILE.md` and `assembly/COMPATIBILITY.md` before choosing a path.
