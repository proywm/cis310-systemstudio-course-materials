...
\newcommand{\instructorcheck}[1]{\textcolor{MichiganBlue}{\textbf{Confirm in Canvas:}} #1}
...
\vspace{7pt}
\colorbox{MichiganMaize}{\parbox{0.92\textwidth}{\centering\bfseries Instructor-review working syllabus --- update the highlighted Canvas-controlled fields before student release.}}
\vspace{7pt}
...
Class time and location & \instructorcheck{section, CRN, meeting time, room, and delivery mode}\\
Office hours & \instructorcheck{office location, days/times, and appointment method}\\
Course site & \canvas\\
...
\instructorcheck{textbook titles/editions and whether each is required or recommended.} Historical textbook editions have deliberately not been carried into this Fall 2026 draft.
...
Quizzes and examinations & \instructorcheck{number, format, point values, make-up rules, and coverage.}\\
...
Course grade & \instructorcheck{assessment weights or total points, grade scale, late-work rules, incomplete requirements, and instructor-requested withdrawal policy.}\\
\end{tabularx}
...
\begin{itemize}
  \item Use the Canvas method specified by the instructor for course questions and private matters. \instructorcheck{the normal response-time expectation and preferred communication channel.}
...
Current academic policies, including attendance, grading, final examinations, and academic conduct, are linked from the University's \href{https://umdearborn.edu/policies-and-procedures/academic-policies-and-procedures}{Academic Policies and Procedures} page. Student support and well-being resources remain available through UM-Dearborn. Canvas announcements will identify any additional course-specific policies after instructor review.
...
\section{Instructor finalization checklist}

Before releasing this syllabus to students, confirm and replace the remaining Canvas-controlled fields:

\begin{itemize}
  \item section/CRN, meeting time, room, and delivery mode;
  \item office hours, office/online location, communication channel, and response-time expectation;
  \item required/recommended textbooks and editions;
  \item assessment categories, points or weights, grade scale, late/make-up rules, and incomplete/withdrawal language;
  \item assignment, quiz, examination, and project dates;
  \item final-exam time and room from the official schedule;
  \item attendance/participation and assignment-specific collaboration/AI rules; and
  \item accessibility review of the PDF, presentations, assignments, simulator workflow, and assembly lab.
\end{itemize}

\vfill
\footnotesize
\textbf{Source note.} Updated August 19, 2026. The current UM-Dearborn catalog supplies the course title, credits, description, and prerequisites. The official UM-Dearborn 2026--2027 academic calendar supplies term dates. The locally packaged Fall 2026 course materials supply the topic sequence. No historical schedule, room, office hours, textbook edition, grading distribution, attendance penalty, assignment deadline, or final-exam time has been carried forward. Current Fall 2026 Canvas information is authoritative.
