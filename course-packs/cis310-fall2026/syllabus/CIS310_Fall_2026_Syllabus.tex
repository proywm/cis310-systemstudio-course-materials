...
SystemStudio CIS 310 & The VS Code extension maps all 13 lecture topics to focused open-book readings, official author videos, and readiness questions. It also provides quiz mode, confidence checks, explanations, review, the syllabus, calendar, 13 offline presentation PDFs, six assignment references, setup checks, a guided tutorial, and a local help router.\\
...
Collaboration and generative-AI permissions are assignment-specific. If a Canvas assignment does not clearly authorize a type of assistance, ask the instructor before using it in submitted work. The U-M Maizey course tutor may support formative learning through incremental hints, analogous examples, source links, and checks of student-supplied reasoning. It must not be treated as an answer key, a source of deadline or grading decisions, or a way to produce submission-ready work. AI output can be inaccurate; students remain responsible for checking it against course evidence and for the work they submit. The SystemStudio workflow may organize instructor-approved materials and explain visible tool evidence, but it does not replace the student's reasoning or certify that an answer is correct.
