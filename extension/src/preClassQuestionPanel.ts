...
<div class="field"><label for="attempted">What did you already try or check?</label><textarea id="attempted" maxlength="2000" placeholder="For example: book section, lecture slide, truth-table row, exact Digital error, or assembly trace."></textarea></div>
