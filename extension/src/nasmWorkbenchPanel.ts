...
</style></head><body><header><h1>Actual NASM 32-bit Workbench</h1><div class="subtitle">${escapeHtml(path.basename(this.uri.fsPath))} · assemble → link → run/test → debug → inspect → explain</div></header><main>
