      ...
      try {
        switch (request.type) {
          ...
          case 'open-artifact':
            ...
            break;
          case 'open-real-artifact':
            await vscode.commands.executeCommand('systemstudioCis310.openGuidedLabRealArtifact', request.labId, request.artifactId);
            break;
          case 'open-tutor':
