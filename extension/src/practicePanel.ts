...
<aside class="help-widget" aria-label="CIS 310 help"><section id="helpCard" class="help-card"><div class="help-card-head"><div><h2>Questions? Start here.</h2><p>Attempt first. Use the local FAQ or AI tutor for a hint and reasoning feedback—not an answer or graded deliverable—or send a focused question before class.</p></div><button id="helpClose" class="help-close" aria-label="Close help message">×</button></div><div class="actions"><button class="secondary" data-help="faq">FAQ chat</button><button class="secondary" data-help="ai-tutor">AI learning coach</button><button class="quiet" data-help="before-class">Ask before class</button></div></section><button id="helpBubble" class="help-bubble" aria-label="Open CIS 310 help" aria-expanded="true">💬</button></aside>
