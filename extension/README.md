...
7. Use the local FAQ, U-M Codex CLI learning coach, or structured Canvas Question Before Class when help is needed.
...
- local FAQ routing, U-M Codex CLI readiness with persistent attempt-first guardrails, and Canvas Questions Before Class support; and
